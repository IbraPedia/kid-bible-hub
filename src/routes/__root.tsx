...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Biblia ya Watoto: app ya bure ya hadithi za Biblia kwa Kiswahili na Kiingereza, salama na yenye kufurahisha kwa watoto." },
      { name: "author", content: "Biblia ya Watoto" },
